...
import { Plus, Search, Calendar, FileText, Trash2, Edit, Download, BookOpen, Clock, AlertCircle } from 'lucide-react';
...
const AssignmentsPage = () => {
  ...
  const resetForm = () => {
    setFormData({ title: '', module: '', dueDate: '', status: 'pending', priority: 'Medium', notes: '' });
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      case 'submitted': return <Badge variant="success" className="rounded-lg px-2 text-[10px] h-6 flex items-center">Done</Badge>;
